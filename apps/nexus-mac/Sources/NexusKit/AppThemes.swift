...
public extension AppTheme {
    ...
    static let daylight = AppTheme(
        ...
        tokens: ThemeTokens(
            ...
            chromeBorderFocus: "#E0632E",
            chromeTitle: "#2B2420",
            chromeDivider: "#ECE3D3",
            accentDefault: "#E0632E",
            ...
            infoBorder: "#5F9AD6",
            streamCursor: "#E0632E",
            streamThinking: "#8C8178",
            streamText: "#2B2420",
            diffAddedFg: "#2F8F5C",
            diffAddedBg: "#E4F3E8",
            diffRemovedFg: "#C1392B",
            diffRemovedBg: "#FBE4E0",
            diffContext: "#8C8178",
            diffGutter: "#C7B89E",
            syntaxKeyword: "#C1392B",
            syntaxFunction: "#2A6FB0",
            syntaxType: "#A9720E",
            syntaxString: "#2F8F5C",
            syntaxNumber: "#8A4FC7",
            syntaxComment: "#8C8178",
            syntaxOperator: "#6B6058",
            syntaxVariable: "#2B2420",
            syntaxConstant: "#2A6FB0",
            syntaxTag: "#2F8F5C",
            syntaxAttribute: "#A9720E",
            syntaxInvalid: "#C1392B",
...
public extension AppTheme {
    ...
    static let studio = AppTheme(
        ...
        tokens: ThemeTokens(
            ...
            chromeBorderFocus: "#1E7DE0",
            chromeTitle: "#1D2126",
            chromeDivider: "#E4E7EA",
            accentDefault: "#1E7DE0",
            ...
            infoBorder: "#5FA0E8",
            streamCursor: "#1E7DE0",
            streamThinking: "#838C96",
            streamText: "#1D2126",
            diffAddedFg: "#1E8E5A",
            diffAddedBg: "#E4F3EA",
            diffRemovedFg: "#C4342B",
            diffRemovedBg: "#FBE5E3",
            diffContext: "#838C96",
            diffGutter: "#B7BFC8",
            syntaxKeyword: "#A626A4",
            syntaxFunction: "#1E7DE0",
            syntaxType: "#0F68A0",
            syntaxString: "#1E8E5A",
            syntaxNumber: "#B27B0E",
            syntaxComment: "#838C96",
            syntaxOperator: "#5B6570",
            syntaxVariable: "#1D2126",
            syntaxConstant: "#0F68A0",
            syntaxTag: "#C4342B",
            syntaxAttribute: "#B27B0E",
            syntaxInvalid: "#C4342B",
        ...
        elevation: ElevationLadder(
            ...
            level3: ElevationStep(surface: "#FFFFFF", border: "#1E7DE0", shadowOpacity: 0.10, shadowRadius: 10)
        ),
        materials: MaterialUsage(sidebar: .solid, overlay: .solid, composer: .solid),
        gradients: GradientSet(
            surfaceWash: ["#F5F6F8", "#F5F6F8"],
            accentGradient: ["#1E7DE0", "#0A66C2"]
        ),
        stateLayers: StateLayers(hover: 0.05, pressed: 0.09, selected: 0.12, disabled: 0.40),
        accents: AccentSystem(primary: "#1E7DE0", secondary: "#7247B0"),
        typography: .neutral
    )
}
